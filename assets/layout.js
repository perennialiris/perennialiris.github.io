...
const socialLinksdata = `<div><a title="This github repo" class="plug" href="https://github.com/perennialiris">${ githubLogoSvg }</a></div>
<div><a title="My YouTube channel" class="plug" href="https://www.youtube.com/channel/UCXadODjAtT72eYW6xCGyuUA">${ youtubeLogoSvg }</a></div>
<div><a title="My tumblr account" class="plug" href="https://perennialiris.tumblr.com/">${ tumblrLogoSvg }</a></div>
<div><a title="Twitter" class="plug" href="https://x.com/perennialforces">${ twitterLogoSvg }</a></div>
<div><a title="Bluesky" class="plug" href="https://bsky.app/profile/perennialforces.bsky.social">${ blueskyLogoSvg }</a></div>
<div><a title="Invite to my Discord server" class="plug" href="https://discord.gg/fGdV7x5dk2">${ discordLogoSvg }</a></div>
<div><a title="My account on Substack" class="plug" href="https://perennialiris.substack.com">${ substackLogoSvg }</a></div>`;
...
const articleFooterImage = `<img alt="Theme painting ('A Beauty Holding a Bird' by Louis Emile Pinel de Grandchamp)" src="${ document.getElementById("index") ? "assets/grandchamp.png" : "../../assets/grandchamp.png" }" width="100" height"100">`;
                ...
                <div id="article-footer">
                    <div class="align-center gap-em">
                        ...
                        <div class="column gap-8">
                            <div>I&rsquo;m Iris, a ${ age_() }-year-old liberal writer from Ottawa, Canada. I write about politics and stuff and then post to various websites and now sometimes make videos.</div>
                            <div class="gap-3">
                                ${ socialLinksdata }
                            </div>
                        </div>
