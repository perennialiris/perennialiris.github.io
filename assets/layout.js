...
const discordSvg = `<svg class="inline-logo" role="img" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 16 16"><path fill="var(--discord)" d="M13.545 2.907a13.2 13.2 0 0 0-3.257-1.011.05.05 0 0 0-.052.025c-.141.25-.297.577-.406.833a12.2 12.2 0 0 0-3.658 0 8 8 0 0 0-.412-.833.05.05 0 0 0-.052-.025c-1.125.194-2.22.534-3.257 1.011a.04.04 0 0 0-.021.018C.356 6.024-.213 9.047.066 12.032q.003.022.021.037a13.3 13.3 0 0 0 3.995 2.02.05.05 0 0 0 .056-.019q.463-.63.818-1.329a.05.05 0 0 0-.01-.059l-.018-.011a9 9 0 0 1-1.248-.595.05.05 0 0 1-.02-.066l.015-.019q.127-.095.248-.195a.05.05 0 0 1 .051-.007c2.619 1.196 5.454 1.196 8.041 0a.05.05 0 0 1 .053.007q.121.1.248.195a.05.05 0 0 1-.004.085 8 8 0 0 1-1.249.594.05.05 0 0 0-.03.03.05.05 0 0 0 .003.041c.24.465.515.909.817 1.329a.05.05 0 0 0 .056.019 13.2 13.2 0 0 0 4.001-2.02.05.05 0 0 0 .021-.037c.334-3.451-.559-6.449-2.366-9.106a.03.03 0 0 0-.02-.019m-8.198 7.307c-.789 0-1.438-.724-1.438-1.612s.637-1.613 1.438-1.613c.807 0 1.45.73 1.438 1.613 0 .888-.637 1.612-1.438 1.612m5.316 0c-.788 0-1.438-.724-1.438-1.612s.637-1.613 1.438-1.613c.807 0 1.451.73 1.438 1.613 0 .888-.631 1.612-1.438 1.612"/></svg>`;
const substackSvg = `<svg class="inline-logo substack-logo" role="img" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 64 64"><path fill="var(--substack)" d="M8 10 H56 V16 H8 Z" /><path fill="var(--substack)" d="M8 22 H56 V28 H8 Z" /><path fill="var(--substack)" d="M8 34 H56 V62 L32 50 L8 62 Z" /></svg>`;
const socialLinks = `
<div><a title="YouTube" class="plug" href="https://www.youtube.com/channel/UCXadODjAtT72eYW6xCGyuUA">${ youtubeSvg }</a></div>
<div><a title="Tumblr" class="plug" href="https://perennialiris.tumblr.com/">${ tumblrSvg }</a></div>
<div><a title="Twitter" class="plug" href="https://x.com/perennialforces">${ twitterSvg }</a></div>
<div><a title="Bluesky" class="plug" href="https://bsky.app/profile/perennialforces.bsky.social">${ blueskySvg }</a></div>
<div><a title="Substack" class="plug" href="https://perennialiris.substack.com">${ substackSvg }</a></div>
`;
...
const articleFooterImage = `<img class="theme-image" alt="Theme painting ('A Beauty Holding a Bird' by Louis Emile Pinel de Grandchamp)" src="${ document.getElementById("index") ? "assets/grandchamp.png" : "../../assets/grandchamp.png" }" width="100" height"100">`;

function age_() {
    const today = new Date();
    let age = today.getFullYear() - 1994;
    return today.getMonth() > 3 ? age : age - 1;
}
        ...
        <div class="c2">
            <div class="c3">
                ...
                <div id="article-footer">
                    <div class="align-center gap-em">
                        <div>${ articleFooterImage }</div>
                        <div class="column gap-5">
                            <div>I&rsquo;m a ${ age_() }-year-old liberal writer from Ottawa, Canada. I write about politics and stuff and then post to various websites and now sometimes make videos.</div>
                            <div class="gap-3">
                                ${ socialLinks }
                            </div>
                        </div>
                    ...
                    <div>
                        <div>Use Discord? ${ discordSvg } Check out the server I run: <a href="https://discord.gg/fGdV7x5dk2">https://discord.gg/fGdV7x5dk2</a></div>
                    </div>
                </div>
            </div>
        </div>
